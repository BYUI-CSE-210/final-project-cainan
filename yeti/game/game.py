    ...
    def start_game(self):
        ...
        for i in range(60):
            ...
            if not i % 12 and not i ==0:
                ...
                axeman_platform_collision_detect_deed = DetectPlatformCollisionsDeed(platforms, axeman)
                deeds_service.register_deed(axeman_platform_collision_detect_deed, "action")
        ...
        axemen_apply_gravity_deed = ApplyGravityDeed(axemen, service_manager)
        ...
        deeds_service.register_deed(axemen_apply_gravity_deed, "action")
